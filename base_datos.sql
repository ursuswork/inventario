CREATE TABLE recibos_unidad (
    ...
    bases VARCHAR(10), soportes VARCHAR(10), turbo VARCHAR(10), escape VARCHAR(10),
    chicotes VARCHAR(10),
    ...
    cables VARCHAR(10), cables_sensores VARCHAR(10), conectores VARCHAR(10), electro_valvulas VARCHAR(10),
    fusibles VARCHAR(10), porta_fusibles VARCHAR(10), indicadores VARCHAR(10),
    presion_agua_temp_volt VARCHAR(10), luces VARCHAR(10), modulos VARCHAR(10), torreta VARCHAR(10),
    relevadores VARCHAR(10), switch_llave VARCHAR(10), sensores_ee VARCHAR(10),

    estetico VARCHAR(10), pintura VARCHAR(10), calcomanias VARCHAR(10), asiento VARCHAR(10),
    tapiceria VARCHAR(10), tolvas VARCHAR(10), cristales VARCHAR(10), accesorios VARCHAR(10),

    sistema_riego VARCHAR(10),
